...
namespace vidf
{
	...
	struct Matrix44
	{
		...
		template<typename U>
		explicit Matrix44(const Matrix33<U>& mt33)
			: m00(U(mt33.m00)), m01(U(mt33.m01)), m02(U(mt33.m02)), m03(0)
			, m10(U(mt33.m10)), m11(U(mt33.m11)), m12(U(mt33.m12)), m13(0)
			, m20(U(mt33.m20)), m21(U(mt33.m21)), m22(U(mt33.m22)), m23(0)
			, m30(0)          , m31(0)          , m32(0)          , m33((T)1) {}

		template<typename U>
		explicit Matrix44(const Matrix44<U>& mt44)
			: m00(U(mt44.m00)), m01(U(mt44.m01)), m02(U(mt44.m02)), m03(U(mt44.m03))
			, m10(U(mt44.m10)), m11(U(mt44.m11)), m12(U(mt44.m12)), m13(U(mt44.m13))
			, m20(U(mt44.m20)), m21(U(mt44.m21)), m22(U(mt44.m22)), m23(U(mt44.m23))
			, m30(U(mt44.m30)), m31(U(mt44.m31)), m32(U(mt44.m32)), m33(U(mt44.m33)) {}
	...
	template<typename T>
	T Determinant33(const Matrix44<T>& m)
	{
		T det = T(0);
		det += m.m00 * (m.m11 * m.m22 - m.m21 * m.m12);
		det -= m.m10 * (m.m01 * m.m22 - m.m21 * m.m02);
		det += m.m20 * (m.m01 * m.m12 - m.m11 * m.m02);
		return det;
	}


	template<typename T>
	T Determinant(const Matrix44<T>& m)
	{
		T inv[16];
		int i;
